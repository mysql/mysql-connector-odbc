...
// from MYSQL_FIELD struct in MySQL 8.3.0 and 9.0.0
// Note: These fields were added back in 8.4.0 (to keep ABI compatibility)
// and then removed in 9.0.0 and added back in 9.1.0
