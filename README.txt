...
License information can be found in the LICENSE.txt file. This distribution may
include materials developed by third parties. For license and attribution
notices for these materials, please refer to the LICENSE.txt file.

For more information on MySQL Connector/ODBC, visit
http://dev.mysql.com/doc/connector-odbc/en

For additional downloads and the source of MySQL Connector/ODBC,
