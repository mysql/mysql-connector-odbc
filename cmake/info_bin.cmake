...
FUNCTION(GENERATE_INFO_BIN)
  ...
  install(FILES "${CMAKE_SOURCE_DIR}/INFO_BIN" DESTINATION ${INSTALL_DOCDIR} COMPONENT Readme)
ENDFUNCTION()
...
FUNCTION(GENERATE_INFO_SRC)
  ...
  ENDIF()
  install(FILES "${CMAKE_SOURCE_DIR}/INFO_SRC" DESTINATION ${INSTALL_DOCDIR} COMPONENT Readme)
ENDFUNCTION()
