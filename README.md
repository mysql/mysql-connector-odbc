...
Please refer to the [README.txt](README) and [LICENSE.txt](LICENSE) files, available in this repository, and [Legal Notices in documentation](https://dev.mysql.com/doc/relnotes/connector-odbc/en/preface.html) for further details.
